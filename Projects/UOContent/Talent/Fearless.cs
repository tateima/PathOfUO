namespace Server.Talent
{
    public class Fearless : BaseTalent
    {
        public Fearless()
        {
            ...
            Description = "Decreases chance to be feared by 5% per point. Requires at least 80+ melee skill.";
            ImageID = 411;
            GumpHeight = 85;
            AddEndY = 80;
        }
        ...
        public bool CheckFearSave(Mobile from) => HasSkillRequirement(from) && Utility.Random(100) < Level * 5;
    }
}
