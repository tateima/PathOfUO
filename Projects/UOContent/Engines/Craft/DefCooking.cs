...
namespace Server.Engines.Craft
{
    public class DefCooking : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(typeof(CakeMix), 1044495, 1041002, 65.0, 100.0, typeof(SackFlour), 1044468, 1, 1044253);
            AddRes(index, typeof(SweetDough), 1044475, 1, 1044253);

            index = AddCraft(typeof(CookieMix), 1044495, 1024159, 5.0, 100.0, typeof(JarHoney), 1044472, 1, 1044253);
            AddRes(index, typeof(SweetDough), 1044475, 1, 1044253);

            if (Core.ML)
            {
                index = AddCraft(typeof(CocoaButter), 1044495, 1079998, 40.0, 100.0, typeof(CocoaPulp), 1080530, 1, 1044253);
                SetItemHue(index, 0x457);
                SetNeededExpansion(index, Expansion.ML);
                SetNeedOven(index, true);

                index = AddCraft(typeof(CocoaLiquor), 1044495, 1079999, 40.0, 100.0, typeof(CocoaPulp), 1080530, 1, 1044253);
            ...
            /* Begin Preparations */
            index = AddCraft(typeof(UnbakedQuiche), 1044496, 1041339, 50.0, 100.0, typeof(Dough), 1044469, 1, 1044253);
            ...
            index = AddCraft(typeof(UnbakedPeachCobbler), 1044496, 1041335, 30.0, 100.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(Peach), 1044480, 1, 1044253);

            index = AddCraft(typeof(UnbakedApplePie), 1044496, 1041336, 80.0, 100.0, typeof(Dough), 1044469, 1, 1044253);
            AddRes(index, typeof(Apple), 1044479, 1, 1044253);

            index = AddCraft(typeof(UnbakedPumpkinPie), 1044496, 1041342, 90.0, 100.0, typeof(Dough), 1044469, 1, 1044253);
            ...
            index = AddCraft(typeof(Muffins), 1044497, 1022539, 25.0, 100.0, typeof(SweetDough), 1044475, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(Quiche), 1044497, 1041345, 55.0, 100.0, typeof(UnbakedQuiche), 1044518, 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(MeatPie), 1044497, 1041347, 55.0, 100.0, typeof(UnbakedMeatPie), 1044519, 1, 1044253);
            SetNeedOven(index, true);
            ...
            index = AddCraft(typeof(ApplePie), 1044497, 1041343, 85.0, 100.0, typeof(UnbakedApplePie), 1044524, 1, 1044253);
            SetNeedOven(index, true);
            ...
            index = AddCraft(typeof(FishSteak), 1044498, 1022427, 20.0, 100.0, typeof(RawFishSteak), 1044476, 1, 1044253);
            SetNeedHeat(index, true);
            SetUseAllRes(index, true);

            index = AddCraft(typeof(FriedEggs), 1044498, 1022486, 25.0, 100.0, typeof(Eggs), 1044477, 1, 1044253);
            SetNeedHeat(index, true);
            SetUseAllRes(index, true);
            ...
            index = AddCraft(typeof(Ribs), 1044498, 1022546, 35.0, 100.0, typeof(RawRibs), 1044485, 1, 1044253);
            SetNeedHeat(index, true);
            SetUseAllRes(index, true);
            /* End Barbecue */
