...
public abstract class BaseAI
{
    ...
    public void DisableTraining(Mobile mobile) {
        mobile.PublicOverheadMessage(MessageType.Regular, 0x3B2, true, "I am unable to train thee. Sorry.", false);
    }
